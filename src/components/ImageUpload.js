        ...
        <div className="container mt-5">
            ...
            <div className="d-flex flex-wrap">
                {images.map((img, index) => (
                    <img key={index} src={img} alt="Uploaded" className="m-2 rounded" style={{ width: "150px", height: "150px", objectFit: "cover" }} />
                ))}
            </div>
...
const CategoryDropdown = ({ selectedCategory, setSelectedCategory, selectedSubcategory, setSelectedSubcategory, selectedBrand, setSelectedBrand }) => {
    const categories = {
        "Automobile": {
            "Bike": ["Atlas Honda", "Pak Suzuki", "Yamaha", "Super Star", "Road Prince", "United", "Other"],
            "Car": ["Honda", "Suzuki", "Toyota", "Hyundai", "KIA", "Changan", "DFSK", "Other"],
            "Truck": ["Hino", "Isuzu", "Master", "FAW", "Shacman", "Other"]
        },
        "Clothing & Accessories": {
            "Shoes": ["Bata", "Servis", "Borjan", "Nike", "Adidas", "Metro", "Other"],
            "Handbag": ["Jafferjees", "Gucci", "Louis Vuitton", "Michael Kors", "Other"],
        ...
        "Electronics": {
            ...
            "Mobile Phone": ["Samsung", "Apple", "Oppo", "Vivo", "Realme", "Infinix", "Tecno", "Other"],
            "Tablet": ["Apple", "Samsung", "Huawei", "Lenovo", "Other"]
        },
        "Home Appliances": {
            "Air Conditioner": ["Dawlance", "Orient", "Haier", "PEL", "Gree", "Kenwood", "Other"],
