...
function Pwa_App() {
 ...
 <div className="text-center my-5">
  <h1 className="fw-bold mb-4" style={{ fontSize: '2.5rem', color: '#0d6efd' }}>
    <i className="fas fa-rocket me-2"></i>Welcome to <span style={{ color: '#198754' }}>MyApp</span>
  </h1>

  <p className="lead mb-4">
    Experience the app like never before! Install it to enjoy full-screen mode and faster access.
  </p>
  ...
  {showInstallButton ? (
    ...
    <div className="alert alert-info mt-4" style={{ maxWidth: '400px', margin: '0 auto' }}>
      <i className="fas fa-info-circle me-2"></i>
      App is already installed or installation is not available on this device/browser.
    </div>
  )}
</div>
